...
<nav class="container my-3">
	<ul class="nav text-center sns">
		...
		<li class="nav-item"><a class="nav-link text-white share-twitter" href="https://twitter.com/intent/tweet?text=<?php echo $share_title; ?>&url=<?php echo $share_url; ?>&related=BHCrusher1" target="_blank" rel="noopener">Twitter</a></li>
